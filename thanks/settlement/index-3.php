...
<body>
    <form class="form-signin">
        <div class="text-center mb-4 bg-atas">
            <img class="mb-4" src="img/brand-m1.png" alt="" width="72" height="72">
            <h1 id="terima-kasih" class="h3 mb-3 font-weight-bold">Terima kasih telah mendaftar</h1>
            <h3 id="keterangan">Tim kami akan menghubungi Anda</h3>
