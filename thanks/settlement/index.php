...
<h1 class="h3 mb-3 font-weight-bold">Terima Kasih!</h1>
            <h3>Pembayaran berhasil.</h3>

            <hr style=" margin-top: 3rem !important ; margin-bottom: 3rem !important ;">

            <h1 class="h3 mb-3 font-weight-normal">Dapatkan Inspirasi Setiap Hari dan Tetap Terhubung Bersama Social
        ...
        <p class="mt-5 mb-3 text-muted text-center">Copyright © 2020 PT Merry Riana Motivasi Dua. All Rights Reserved.</p>
