<script>
    ...
    function usiaValidationBawah() {
        var usiaValue = $('#usia-bawah').val();
        var usiaElement = document.getElementById('usia-bawah');
        var goodColor = "#66cc66";
        var badColor = "red";

        if (usiaValue.length <= 0) {
            $('#div-usia-validation-bawah').show();
            usiaElement.style.borderColor = badColor;
        } else {
            $('#div-usia-validation-bawah').hide();
    ...
    $("#btn-submit-bawah").click(function(e) {
        ...
        if (name != '' && $('#hp-bawah').val() != '' && isPhoneValidBawah == "true" && email != '' &&
            isEmailValidBawah == "true" && campaign != '' && $("#usia-bawah").val() != '') {
