...
<body id="page-top" style="min-width: 100%;">
    ...
    <header class="mastheads warna-bg-abu" style="padding-top: 2rem; padding-bottom: 2rem;min-height: 20rem;">
                ...
                <div class="col-md-12 desktop">
                    <div class="row">
                        <div class="col-md-8 align-left">
                            ...
                            <h3>Sesi Perkenalan : <span id="tanggal-webinar"><div class="spinner-border custom-spinner"></div>Loading...</span><br/>
                            (Dibawakan oleh Merry Riana Associate Trainer)</h3>
                            <a href="#form-abu" style="padding-left: 36px; padding-right: 36px; background-color: #572a32 ; color: white;" class="btn btn-lg buttonss my-4"><i class="far fa-hand-point-right"></i> Daftar Sekarang</a><br/>
      ...
      <!--                  <h3 class="mb-4 mt-4 style-judul" style="font-size: 30px;">NO. 1 PUBLIC SPEAKING FOR KIDS AND TEENS</h3>-->
                        ...
                        <span id="tanggal-webinar-mobile"><div class="spinner-border custom-spinner"></div>Loading...</span>
                        <br/>(Dibawakan oleh Merry Riana Associate Trainer)</h4>
                ...
                <div class="container">
                    <div class="row">
                        <div class="desktop">
                            <div class="container">
                                ...
                                <h1 class="style-judul mb-2" style="font-size: 20px">Merry Riana School of Public Speaking telah berhasil mengubah ribuan anak menjadi lebih percaya diri  dan kini giliran anak Anda membuktikannya!!!</h1>
					...
					<div class="row">			
                        <div class="col-md-12 mx-auto mt-5">
        					<h1 class="style-judul text-center">MANFAAT MENGUASAI KETERAMPILAN PUBLIC SPEAKING UNTUK ANAK ANDA</h1>
        				</div>
        			</div>
					<div class="row">
        ...
        <div class="row">
            <div class="col-md-12 warna-bg-abu pl-3" style="padding-top: 2rem; padding-bottom: 1rem;">
                <div class="container">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12 mx-auto text-center">
                            <a href="#form-abu" style="padding-left: 36px; padding-right: 36px; background-color: #ae0001; color: white;" class="btn buttonss btn-lg my-4"><i
                                    class="far fa-hand-point-right"></i> Daftar Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="desktop" style="position:sticky;top:6rem;z-index:1000;margin-right:10px;">
                <div class="instructor_pricing_widget">
                    <div class="instructor_price">
                        ...
                        <div class="text-danger" style="color: #572a32 ;"><div id="countdownx" class="offer-countdown" style="color: #572a32 ; margin: 10px;">Diskon Segera Berakhir <br> <span id="countdown-timer">05:18:49</span></div></div>
                    ...
                    <div class="modal-content">
                      <div class="modal-body">
                        <div class="video-container">
                            <iframe id="video-review" title="Video Testi Merry Riana Merry Riana School Of Public Speaking" width="800" height="" src="https://www.youtube.com/embed/ycxHJYHgMuM" frameborder="0"
    ...
    <script>
        ...
        var urlSnap = "https://payment.merryriana.com/mrlcempatbelas/invoice/xendit_product_m1";
        var kodeAwal = 'M1ID-';
